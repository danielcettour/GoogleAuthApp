...
fun LoginContent(
    ...
    /**
     * Column is used similar to Linear Layout, with vertical orientation and weights.
     * In this case 10% of the top section is used to contain the message bar state
     */
    Column(
...
fun CentralContent(
    ...
    GoogleButton(
        loadingState = signedInState, // passed as parameter
        onClick = onButtonClicked
    )
}

@Composable
@Preview(showBackground = true, showSystemUi = true) // parameters to the preview, to show background and system UI
